<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PanelModificar.aspx.cs" Inherits="PaginaOldTekno.PanelModificar" %>
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li  >
					   ...
					   <li  >
                        <a class="active-menu"   href="PanelModificar.aspx"><i class="fa fa-dashboard fa-3x"></i>Modificar</a>
                    </li>	                 
                   <li  >
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Información</h2>   
                        <h5>Bienvenido al panel de modificar aqui podras cambiar la contraseña y la vigencia de un usuario.</h5>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <form role="form" runat="server">
                                        ...
                                        <button class="btn btn-primary" runat="server" onserverclick="MenuAccion"><i class="fa fa-edit "></i>Cambiar contraseña</button>
                                        <button class="btn btn-primary" runat="server" onserverclick="MenuAccion1"><i class="fa fa-edit "></i>Cambiar vigencia</button>
                                        ...
                                        <span class="input-group-addon" >Contraseña nueva:</span>
                                            ...
                                            <asp:Button ID="Button3" OnClick="CambiarContraseña" runat="server"  Text="Actualizar" />
                                         </div>
                                             <div  style ="<%=hola2%>" class="form-group input-group" >
                                        <span class="input-group-addon" >Rut:</span>
                                            <asp:TextBox ID="TextBox3"  class="form-control" runat="server"></asp:TextBox>
                                        <span class="input-group-addon" >Vigencia nueva:</span>
                                            ...
                                            <asp:Button ID="Button1" OnClick="CambiarVigencia" runat="server"  Text="Actualizar" />
                                         </div>
