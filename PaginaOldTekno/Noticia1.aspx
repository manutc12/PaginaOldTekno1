<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Noticia1.aspx.cs" Inherits="PaginaOldTekno.Noticia1" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    ...
    <title>Noticias |Actualizacion 26/11/2020</title>
     ...
     <div class="row">
       <div class="col-md-12">
         <div class="mu-page-breadcrumb-area">
           <h2>Actualizacion 05/06/2021</h2>
           <ol class="breadcrumb">
            <li><a href="PaginaInicial-aspx">Inicio</a></li>            
                    ...
                    <div class="col-md-12">
                      <article class="mu-blog-single-item">
                        <figure class="mu-blog-single-img">
                          <a href="#"><img alt="img" src="assets/MarkUps-Varsity/Varsity/assets/img/blog/noti1.jpg"></a>
                          <figcaption class="mu-blog-caption">
                            <h3>¿Que cambios se realizaron?</h3>
                          </figcaption>                      
                        </figure>
                        ...
                        <div class="mu-blog-description">
                          <p>Buenas tardes, les informo mediante este medio las actualizaciones y cambios del sitio Web OldTekno con fecha 05 de Junio del 2021.  </p>
                          <p></p>
                          <blockquote>
                          ...
                          <ul>
                            <li> Se agrega curso: Que es Hardware y Software</li>
                            <li>Como guardar videos musicales en YouTube</li>
                            <li>Como aprender a usar el correo electronico</li>
                            <li>Como aprender a usar Word</li>
                            <li>Como hacer videollamada con Zoom</li>
                          </ul>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="mu-blog-single-navigation">
                      <a class="mu-blog-prev" href="#"><span class="fa fa-angle-left"></span>Atras</a>
                      <a class="mu-blog-next" href="#">Siguiente<span class="fa fa-angle-right"></span></a>
                    </div>
                  </div>
                </div>
                <!-- end blog navigation -->
                          ...
                          <div class="col-md-6">
                            <article class="mu-blog-single-item">
                              <figure class="mu-blog-single-img">
                                <a href="#"><img alt="img" src="assets/MarkUps-Varsity/Varsity/assets/img/blog/noti1.jpg"></a>
                                <figcaption class="mu-blog-caption">
                                  <h3><a href="#">Actualizacion 05/06/2021</a></h3>
                                </figcaption>                      
                              </figure>
                              <div class="mu-blog-meta">
                              ...
                              <div class="mu-blog-description">
                                <p>Estimados, hemos agregado nuevos cursos y opciones para los administradores.</p>
