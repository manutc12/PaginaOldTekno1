<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="ManuelTorres_WEBFORMS_ACTIVIDAD1.Inicio" %>
...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <h2 class="inactive underlineHover"  ><a href="PaginaAdmin.aspx">Admin</a> </h2>
...
<%--      <img src="http://danielzawadzki.com/codepen/01/icon.svg" id="icon" alt="User Icon" />--%>
    ...
    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover" href="Recuperar.aspx">¿Olvidaste la contraseña?</a>
    </div>
