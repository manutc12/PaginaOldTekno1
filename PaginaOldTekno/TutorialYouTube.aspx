<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TutorialYouTube.aspx.cs" Inherits="PaginaOldTekno.TutorialYouTube" %>
...
<html lang="en">
  <head>
    ...
    <title>OldTekno | Tutorial YouTube</title>
     ...
     <div class="row">
       <div class="col-md-12">
         <div class="mu-page-breadcrumb-area">
           <h2>Como guardar videos musicales en YouTube</h2>
           <ol class="breadcrumb">
            <li><a href="PaginaInicial.aspx">Inicio</a></li>            
            <li class="active">Tutorial YouTube</li>
          </ol>
         </div>
       </div>
     </div>
                    ...
                    <div class="col-md-12">
                      <div class="mu-latest-course-single">
                        <figure class="mu-latest-course-img">
                          <a href="#"><img src="assets/MarkUps-Varsity/Varsity/assets/img/courses/tutoyoutube.jpg" alt="img"></a>
...
<form action="../../form-result.php" method="post" enctype="multipart/form-data" target="_blank">
                            ...
                            <h3><b>Como guardar tus videos favoritos en YouTube</b></h3>
                                <p align="justify" style="font-size:140%">En este video explicativo aprenderas a guardar tus canciones favoritas para poder crear una lista de reproduccion, y asi escucharla en el momento que mas desees.<br> 
                                 Por lo tanto te invitamos a que te quedes y veas el siguiente video:
                                </p>    
                           <div class="mu-about-us-right">                            
                <a id="mu-abtus-video" href="https://www.youtube.com/embed/N71rAZQGNGc" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen target="mutube-video">
                  <img src="assets/MarkUps-Varsity/Varsity/assets/img/courses/tutoyoutubeyt.jpg" alt="img">
                </a>                
                </div>
